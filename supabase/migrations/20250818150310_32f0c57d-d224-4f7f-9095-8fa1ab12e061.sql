-- Fix the profiles table duplicate key issue by adding unique constraint on user_id
-- and updating the upsert logic to use user_id as the conflict target
...
-- Create a function to send task notifications via email and SMS
